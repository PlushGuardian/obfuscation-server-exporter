...
* change cpu metric (#37) ([968bb1d](https://github.com/PlushGuardian/obfuscation-server-exporter/commit/968bb1d6ab828a3a482a536cf735fb51c37a5852))
	- remove metric system_cpu_usage_percent
	- add metric system_cpu_seconds_total


### ⇉ CI

* fix autogenerated changelog (#34) ([90eac73](https://github.com/PlushGuardian/obfuscation-server-exporter/commit/90eac7327559d6f8d174036b375bfb06183215ff))
	* add commit types: feat, fix, perf, docs, refactor, test, build, ci, chore
	* add description to the commits in the changelog
	* fix empty hash sums
	* fix not filtered commits
* fix jobs running on commits with no release (#36) ([f8aae8b](https://github.com/PlushGuardian/obfuscation-server-exporter/commit/f8aae8bbdd90b766a3977cb4e2bc6beb89c1c4be))
